        ...
        <div class="my-4 max-w-3xl mx-auto border rounded-lg p-4" style={{ 'border-color': 'var(--bright-black)' }}>
            ...
            <Show when={props.data.media_type === 'image'}>
                <a href={imageUrl()} target="_blank" rel="noopener noreferrer">
                    <img src={imageUrl()} alt={props.data.title} class="rounded-md w-full object-contain mb-4" />
                </a>
            </Show>
...
export const handler = async (terminal: Terminal, args: DeriveArgs<typeof meta.arguments>, signal: AbortSignal) => {
