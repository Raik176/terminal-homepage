...
|_____|  [___]   [___] \\__/  \\'-;__/'.___.'[\\_:  /     |_____|   '.__.'[___][___]'.___.'[\\_:  /   
            ...
            <div class="max-w-xl text-center animate-slide-in-left">
                ...
                <p class="text-lg leading-relaxed mb-6 text-left px-4 sm:px-0">
                    This website <span style={{ color: "var(--green)", "font-weight": "bold" }}>does not use cookies, tracking scripts, or any analytics services</span>.
                </p>
                <p class="text-lg leading-relaxed mb-6 text-left px-4 sm:px-0">
                    No personal data, IP addresses, browser information, or any other user information is collected,
                    stored, or processed. Your visit is completely anonymous.
                </p>
            </div>
        </main>
    );
